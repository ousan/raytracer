...
Renderer::Renderer(float _width, float _height, Scene _scene, Camera _camera)
...
void Renderer::render_distributed_rays() { 
    int samples = 16;
...
void Renderer::drawImage(Color* image, int width, int height) {
