...
Color Lighting::getLighting(const Object &object, const Vector3 &point, const Vector3 &normal, const Vector3 &view, const vector<Light*> &lights, const vector<Object*> &objects) {
...
bool Lighting::getShadow(const Vector3 &point, const Light &light, const vector<Object*> &objects) {
...
float Lighting::getShadowFactor(const Vector3 &point, const Light &light, const vector<Object*> &objects) { 
...
Color Lighting::getLighting(const Object &object, const Vector3 &point, const Vector3 &normal, const Vector3 &view, const Light *light) {
    Color rayColor;
